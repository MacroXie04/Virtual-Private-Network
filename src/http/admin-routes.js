import { ControlError } from '../control/control-client.js';
import { HttpError, readForm } from './request-input.js';
import { sendGenericError, sendResponse } from './http-service.js';
import { renderDashboardPage, renderSecretPage } from './admin-page.js';
import { html, redirect } from './admin-auth.js';
import { exactForm, valueOnce, operationIdFrom, revisionFrom, sessionRateKey } from './admin-request.js';
