...
import { safeLstat, syncDirectory, ensureOwnedDirectory } from '../filesystem/files.js';
import { inspectKnownRevisionFiles, removeKnownRevisionFiles } from '../filesystem/revision-directory.js';
...
export async function removeRevision(repository, id) {
  ...
  await repository.assertSupportedRevisionSchema(id);
