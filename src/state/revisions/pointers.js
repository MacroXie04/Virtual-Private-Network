...
import { POINTER_NAMES, RepositoryError } from '../filesystem/policy.js';
import { inspectOwnedDirectory, isMissing, safeLstat, syncDirectory } from '../filesystem/files.js';
...
export async function readPointer(repository, name) {
  ...
  if (!await inspectOwnedDirectory(repository.root, owner)) return null;
