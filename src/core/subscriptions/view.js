import { MAX_USERS, PUBLIC_VLESS_PORT, SUBSCRIPTION_VIEW_SCHEMA_VERSION } from '../model/policy.js';
import { validateExtraExits } from '../model/settings.js';
import { validateState } from '../model/state.js';
import { assertUniqueUsers, validateProjectedUser } from '../users/records.js';
import { ValidationError, expectExactKeys, expectInteger, validatePort } from '../validation/values.js';
import { validatePublicDnsHostname, validateWebSocketPath } from '../validation/ingress.js';
...
export function validateSubscriptionView(value) {
  const view = expectExactKeys(value, [
    ...
    'gateway',
    'users',
  ], 'subscriptionView', { optional: ['exits'] });
